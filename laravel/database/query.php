...
class Query {
	...
	{
		return $this->or_where('user_id', '=', $value);		
	}
	 ...
	 * @return object
	 */
	public function find($user_id, $columns = array('*'))
	{
		return $this->where('user_id', '=', $user_id)->first($columns);
	}
	 ...
	 * @return int
	 */
	public function insert_get_id($values, $column = 'user_id')
	{
